...
-- INSERT INTO masi.users(id, email, first_name, last_name, password, username) VALUES (1, 'test@test.com', 'test', 'test', '$2y$11$8KvXgB.vYjQWS16CFQwZxeCsh8g/A5BFjjD/xMdcuwDtgwnHOd1fm', 'test');
