...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Brak wyników do wyświetlenia"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Następna",sPrevious:"Poprzednia"},sEmptyTable:"Brak wyników do wyświetlenia",sInfo:"Wyświetlono _START_ - _END_ z _TOTAL_ wyników",sInfoEmpty:"Wyświetlono 0 - 0 z 0 wyników",sInfoFiltered:"(filtrowanie spośród _MAX_ dostępnych pozycji)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Pokaż _MENU_ wyników",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Przeszukaj:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nie znaleziono pasujących pozycji"},
